...
class CreateChatCompletionResponse {
  ...
  @override
  String toString() => 'CreateChatCompletionResponse[id=$id, choices=$choices, created=$created, model=$model, systemFingerprint=$systemFingerprint, object=$object, usage=$usage]';
