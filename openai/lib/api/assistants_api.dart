...
class AssistantsApi {
  ...
  ///
  /// * [CreateAssistantFileRequest] createAssistantFileRequest (required):
  Future<Response> createAssistantFileWithHttpInfo(String assistantId, CreateAssistantFileRequest createAssistantFileRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/assistants/{assistant_id}/files'
  ...
  Future<AssistantFileObject?> createAssistantFile(String assistantId, CreateAssistantFileRequest createAssistantFileRequest,) async {
    final response = await createAssistantFileWithHttpInfo(assistantId, createAssistantFileRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'AssistantFileObject',) as AssistantFileObject;
  ...
  Future<Response> createRunWithHttpInfo(String threadId, CreateRunRequest createRunRequest,) async {
    // ignore: prefer_const_declarations
  ...
  Future<RunObject?> createRun(String threadId, CreateRunRequest createRunRequest,) async {
    final response = await createRunWithHttpInfo(threadId, createRunRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> deleteAssistantFileWithHttpInfo(String assistantId, String fileId,) async {
    // ignore: prefer_const_declarations
    final path = r'/assistants/{assistant_id}/files/{file_id}'
      .replaceAll('{assistant_id}', assistantId)
  ...
  Future<DeleteAssistantFileResponse?> deleteAssistantFile(String assistantId, String fileId,) async {
    final response = await deleteAssistantFileWithHttpInfo(assistantId, fileId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'DeleteAssistantFileResponse',) as DeleteAssistantFileResponse;
  ...
  Future<Response> getAssistantFileWithHttpInfo(String assistantId, String fileId,) async {
    // ignore: prefer_const_declarations
    final path = r'/assistants/{assistant_id}/files/{file_id}'
      .replaceAll('{assistant_id}', assistantId)
      .replaceAll('{file_id}', fileId);
  ...
  Future<AssistantFileObject?> getAssistantFile(String assistantId, String fileId,) async {
    final response = await getAssistantFileWithHttpInfo(assistantId, fileId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> getMessageFileWithHttpInfo(String threadId, String messageId, String fileId,) async {
    // ignore: prefer_const_declarations
    final path = r'/threads/{thread_id}/messages/{message_id}/files/{file_id}'
      .replaceAll('{thread_id}', threadId)
      .replaceAll('{message_id}', messageId)
      .replaceAll('{file_id}', fileId);
  ...
  Future<MessageFileObject?> getMessageFile(String threadId, String messageId, String fileId,) async {
    final response = await getMessageFileWithHttpInfo(threadId, messageId, fileId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'MessageFileObject',) as MessageFileObject;
  ...
  Future<Response> getRunStepWithHttpInfo(String threadId, String runId, String stepId,) async {
    // ignore: prefer_const_declarations
  ...
  Future<RunStepObject?> getRunStep(String threadId, String runId, String stepId,) async {
    final response = await getRunStepWithHttpInfo(threadId, runId, stepId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> listAssistantFilesWithHttpInfo(String assistantId, { int? limit, String? order, String? after, String? before, }) async {
    // ignore: prefer_const_declarations
    final path = r'/assistants/{assistant_id}/files'
      .replaceAll('{assistant_id}', assistantId);
  ...
  Future<ListAssistantFilesResponse?> listAssistantFiles(String assistantId, { int? limit, String? order, String? after, String? before, }) async {
    final response = await listAssistantFilesWithHttpInfo(assistantId,  limit: limit, order: order, after: after, before: before, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'ListAssistantFilesResponse',) as ListAssistantFilesResponse;
  ...
  /// * [String] before:
  ///   A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include before=obj_foo in order to fetch the previous page of the list. 
  Future<Response> listMessageFilesWithHttpInfo(String threadId, String messageId, { int? limit, String? order, String? after, String? before, }) async {
    // ignore: prefer_const_declarations
    final path = r'/threads/{thread_id}/messages/{message_id}/files'
      .replaceAll('{thread_id}', threadId)
      .replaceAll('{message_id}', messageId);
  ...
  Future<ListMessageFilesResponse?> listMessageFiles(String threadId, String messageId, { int? limit, String? order, String? after, String? before, }) async {
    final response = await listMessageFilesWithHttpInfo(threadId, messageId,  limit: limit, order: order, after: after, before: before, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'ListMessageFilesResponse',) as ListMessageFilesResponse;
  ...
  /// * [String] before:
  ///   A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include before=obj_foo in order to fetch the previous page of the list. 
  Future<Response> listMessagesWithHttpInfo(String threadId, { int? limit, String? order, String? after, String? before, }) async {
    // ignore: prefer_const_declarations
    final path = r'/threads/{thread_id}/messages'
      .replaceAll('{thread_id}', threadId);
  ...
  /// * [String] before:
  ///   A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include before=obj_foo in order to fetch the previous page of the list. 
  Future<ListMessagesResponse?> listMessages(String threadId, { int? limit, String? order, String? after, String? before, }) async {
    final response = await listMessagesWithHttpInfo(threadId,  limit: limit, order: order, after: after, before: before, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] before:
  ///   A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include before=obj_foo in order to fetch the previous page of the list. 
  Future<Response> listRunStepsWithHttpInfo(String threadId, String runId, { int? limit, String? order, String? after, String? before, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<ListRunStepsResponse?> listRunSteps(String threadId, String runId, { int? limit, String? order, String? after, String? before, }) async {
    final response = await listRunStepsWithHttpInfo(threadId, runId,  limit: limit, order: order, after: after, before: before, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
