# openapi.model.CreateSpeechRequest
...
**speed** | **num** | The speed of the generated audio. Select a value from `0.25` to `4.0`. `1.0` is the default. | [optional] [default to 1.0]
