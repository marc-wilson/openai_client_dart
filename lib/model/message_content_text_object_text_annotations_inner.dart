...
class MessageContentTextObjectTextAnnotationsInnerTypeEnum {
  ...
  static const citation = MessageContentTextObjectTextAnnotationsInnerTypeEnum._(r'file_citation');
  static const path = MessageContentTextObjectTextAnnotationsInnerTypeEnum._(r'file_path');
...
class MessageContentTextObjectTextAnnotationsInnerTypeEnumTypeTransformer {
  ...
  MessageContentTextObjectTextAnnotationsInnerTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'file_citation': return MessageContentTextObjectTextAnnotationsInnerTypeEnum.citation;
        case r'file_path': return MessageContentTextObjectTextAnnotationsInnerTypeEnum.path;
        default:
          if (!allowNull) {
