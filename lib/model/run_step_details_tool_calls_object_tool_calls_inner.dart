...
class RunStepDetailsToolCallsObjectToolCallsInner {
  ...
  @override
  String toString() => 'RunStepDetailsToolCallsObjectToolCallsInner[id=$id, type=$type, codeInterpreter=$codeInterpreter, retrieval=$retrieval, function_=$function_]';
...
class RunStepDetailsToolCallsObjectToolCallsInnerTypeEnum {
  ...
  static const retrieval = RunStepDetailsToolCallsObjectToolCallsInnerTypeEnum._(r'retrieval');
  ...
  RunStepDetailsToolCallsObjectToolCallsInnerTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'retrieval': return RunStepDetailsToolCallsObjectToolCallsInnerTypeEnum.retrieval;
